...
from .gazebo_spawner import GazeboModels
from .model import Model
from .basic_models import SPHERE, PEG_BOARD, BOX, SPHERE_COLLISION

rospy.init_node('gazebo_spawner_cube')
spawner = GazeboModels('dual_gazebo')
