...
def main():
    ...
    gripper_client = actionlib.SimpleActionClient('/right/gripper/follow_joint_trajectory', FollowJointTrajectoryAction)
    rospy.loginfo('start gripper service')
    rospy.Service('/gripper_move_right', GripperControl, commandCallback)
    rospy.spin()
