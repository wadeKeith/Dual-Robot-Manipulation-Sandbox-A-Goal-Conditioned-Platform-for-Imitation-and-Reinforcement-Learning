...
class MasterJointMove():
    def __init__(self, init_joints=INIT, duration=DURATION):
        ...
        self.client = actionlib.SimpleActionClient('/left/arm_controller/follow_joint_trajectory',
...
def set_joint_angles_server():
    ...
    s = rospy.Service('left_joint_move', SetJointAngles, handle_set_joint_angles)
