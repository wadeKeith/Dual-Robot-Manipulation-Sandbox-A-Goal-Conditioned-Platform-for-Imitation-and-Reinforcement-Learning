...
class JointMoverClient:
    def __init__(self):
        ...
        rospy.Subscriber('/left/joint_states', JointState, self.joint_state_callback)
        self.service_client = rospy.ServiceProxy('left_joint_move', SetJointAngles)
        rospy.wait_for_service('left_joint_move')
