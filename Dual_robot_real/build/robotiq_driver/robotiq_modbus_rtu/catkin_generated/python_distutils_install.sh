...
echo_and_run cd "/media/jt/Extreme SSD/Github/Dual_robot_real/src/robotiq_driver/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/media/jt/Extreme SSD/Github/Dual_robot_real/src/robotiq_driver/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/media/jt/Extreme SSD/Github/Dual_robot_real/build/robotiq_driver/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
