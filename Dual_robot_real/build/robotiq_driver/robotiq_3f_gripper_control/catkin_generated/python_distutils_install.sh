...
echo_and_run cd "/media/jt/Extreme SSD/Github/Dual_robot_real/src/robotiq_driver/robotiq_3f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/media/jt/Extreme SSD/Github/Dual_robot_real/src/robotiq_driver/robotiq_3f_gripper_control/setup.py" \
     \
    build --build-base "/media/jt/Extreme SSD/Github/Dual_robot_real/build/robotiq_driver/robotiq_3f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
