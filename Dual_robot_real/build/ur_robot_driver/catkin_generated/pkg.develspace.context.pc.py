...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/media/jt/Extreme SSD/Github/Dual_robot_real/src/ur_robot_driver/include;/usr/include;/opt/ros/noetic/include".split(';') if "/media/jt/Extreme SSD/Github/Dual_robot_real/src/ur_robot_driver/include;/usr/include;/opt/ros/noetic/include" != "" else []
