...
echo_and_run cd "/media/jt/Extreme SSD/Github/Dual_robot_real/src/lib/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/media/jt/Extreme SSD/Github/Dual_robot_real/src/lib/ur_kinematics/setup.py" \
     \
    build --build-base "/media/jt/Extreme SSD/Github/Dual_robot_real/build/lib/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
