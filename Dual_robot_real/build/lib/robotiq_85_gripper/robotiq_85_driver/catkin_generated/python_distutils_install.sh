...
echo_and_run cd "/media/jt/Extreme SSD/Github/Dual_robot_real/src/lib/robotiq_85_gripper/robotiq_85_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/media/jt/Extreme SSD/Github/Dual_robot_real/src/lib/robotiq_85_gripper/robotiq_85_driver/setup.py" \
     \
    build --build-base "/media/jt/Extreme SSD/Github/Dual_robot_real/build/lib/robotiq_85_gripper/robotiq_85_driver" \
    install \
    --root="${DESTDIR-/}" \
